...
💔 هلا عمري {message.from_user.mention()} !
        انا بوت اسمي ماس استطيع تشغيل الاغاني في المكالمه المرئيه
...
┗━━━━━━━━━━━━━━┛
 ...
 لمعرفة اوامر هذا البوت اضغط على زر الاوامر ان واجهة مشكلة تواصل مع المطور [بَٰـُـٰٓيَٰـُـٰٓبَٰـُـٰٓر🇧 🇪 🇵 🇵 🇪 🇷](t.me/{me})
━━━━━━━━━━━━━━━━━━**""",
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "قناة البوت الرسمية", url="https://t.me/S_T_Dl"
                    )]
            ]
       ),
    )
